...
const Projects = () => {
    return (
        <div className='projectsContainer' id='projects'>
            <h2>Projects</h2>
            <div className='projects' style={{ display: 'flex', gap: '20px', justifyContent: "center", alignItems: "center" }}>
                ...
                <div style={{ display: 'flex', flexDirection: "column", gap: "10px" }}> <h3 style={{ marginBottom: "10px", fontSize: "30px " }}>Quiz-App</h3>
                    ...
                    <div style={{ display: 'flex', gap: '20px', justifyContent: "flex-start", alignItems: "center", marginTop: "10px" }}>
